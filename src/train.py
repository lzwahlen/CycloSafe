...
#use 80% of segments for training, 10% for validation, 10% for testing
...
#problem: only 858 high-risk segments out of 116625 
...
#threshold 0.5 has highest score (default)
